...
export class WJHFrontPage {
  ...
  async componentWillRender() {
    ...
    this.webpressPage = await new Query<Page>(this.query.connection, new PageQueryArgs({
      slug: "webpress"
    })).result
    this.blogPage = await new Query<Page>(this.query.connection, new PageQueryArgs({
      slug: "updates"
    })).result
    this.blogPosts = await new Query<Post>(this.query.connection, Post.QueryArgs({
    })).results
